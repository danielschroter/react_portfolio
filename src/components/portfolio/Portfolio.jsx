...
const data = [
  {
    ...
    image: IMG6,
    title:
      "ProjectHR21 - NLP-Web-Application to transform the way we work together",
...

  {
    ...
    image: IMG2,
    title:
      "Reinforcement Learning to optimize cost within a multi-agent supply chain",
            ...
            <>
              <div key={id} className="portfolio__item">
                ...
                <div className="portfolio__item-cta">
                  ...
                  <a className="btn btn-primary" onClick={() => toggleTab(id)}>
                    Read More
                  </a>
